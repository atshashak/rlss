2<div class="modal fade" id="computer-apply" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="exampleModalLabel">मुफ्त कंप्यूटर क्लास लिए आवेदन </h4>
            ...
            <div class="modal-body bg-grey">
                ...
                <form class="donation_form row" action="contact_process.php" method="post" id="contactForm" novalidate="novalidate">
                    <div class="dn_form_area mx-auto">
                        ...
                        <div class="form-group col-lg-12 ">
                            <div class="row">
                                <div class="col-lg-4 float-left align-item-center">w
                                    <p>जन्म तिथि</p>
                                </div>
